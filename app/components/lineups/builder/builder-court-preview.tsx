  ...
  return (
    ...
    >
      <div className="relative mx-auto h-76 w-full max-w-80 overflow-hidden rounded-md bg-transparent lg:h-104 lg:max-w-none lg:overflow-visible 2xl:h-120">
        <div className="absolute left-1/2 bottom-8 h-[62%] w-[82%] -translate-x-1/2 rounded-t-full border-t border-l border-r border-[rgb(var(--court-accent-rgb)/0.25)] lg:bottom-5 lg:h-[75%] lg:w-[88%]" />

        <div className="absolute left-1/2 bottom-8 h-28 w-20 -translate-x-1/2 border border-[rgb(var(--court-accent-rgb)/0.25)] lg:bottom-5 lg:h-40 lg:w-28" />

        <div className="absolute left-1/2 bottom-36 h-10 w-20 -translate-x-1/2 rounded-t-full border-t border-l border-r border-[rgb(var(--court-accent-rgb)/0.25)] lg:bottom-45 lg:h-14 lg:w-28" />

        <div className="absolute left-1/2 bottom-15 h-2.5 w-2.5 -translate-x-1/2 rounded-full border border-[rgb(var(--court-accent-rgb)/0.6)] lg:bottom-15 lg:h-3 lg:w-3" />

        <div className="absolute left-1/2 bottom-15 h-px w-12 -translate-x-1/2 bg-[rgb(var(--court-accent-rgb)/0.6)] lg:bottom-15 lg:w-16" />
