...
export function PlayerCardBackHeader({
  ...
  return (
    <div className="relative z-10 grid grid-cols-[38px_1fr_28px] items-center gap-1.5 px-1 pt-1.5 font-michroma uppercase sm:grid-cols-[52px_1fr_36px] sm:gap-2 sm:px-2 sm:pt-2 lg:grid-cols-[72px_1fr_48px] lg:gap-4 lg:px-3 lg:pt-1">
      <PlayerImage
      ...
      <div className="flex flex-col items-center gap-0.5 lg:gap-1">
        <p className="shrink-0 text-[7px] text-white/55 sm:text-[8px] lg:text-xs">
          {player.position}
        </p>
        <p
          className="shrink-0 text-[7px] text-white/55 sm:text-[8px] lg:text-xs"
