...
export function PlayerCardBack({
  ...
  return (
    <div
      className={`statcourt-scroll absolute inset-0 h-full overflow-y-auto overflow-x-hidden overscroll-contain rounded-2xl border bg-[color:color-mix(in_srgb,var(--court-panel)_90%,black)] [-webkit-overflow-scrolling:touch] lg:min-h-134 lg:rounded-3xl ${
