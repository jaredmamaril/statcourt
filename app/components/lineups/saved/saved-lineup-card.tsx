    ...
    >
      <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-2 lg:flex lg:justify-between lg:gap-4">
        <div className="min-w-0">
          <p className="truncate font-michroma text-[10px] text-white lg:text-[17px]">
            {lineup.name}
          </p>

          <p className="mt-0.5 font-michroma text-[8px] text-white/55 lg:mt-1 lg:text-[9px]">
            Saved{" "}
          ...
          <div className="mt-1 flex flex-wrap items-center gap-1">
            <p className="w-fit rounded border border-white/15 bg-white/8 px-1.5 py-0.5 font-michroma text-[7px] uppercase text-white/65 lg:px-2 lg:text-[8px]">
              {statProfileLabel}
            </p>
            ...
            <button
              ...
              className="w-fit cursor-pointer rounded-md border px-2 py-1 font-michroma text-[8px] uppercase shadow-[0_0_10px_rgb(var(--court-accent-rgb)/0.08)] transition hover:scale-105 hover:text-white lg:px-2.5 lg:py-1.5 lg:text-[9px]"
              style={{
      ...
      <div>
        <p
          className="mt-1 font-michroma text-[10px] lg:text-[15px]"
          style={{
        ...
        <p
          className="mt-0.5 font-michroma text-[9px] lg:mt-1 lg:text-[12px]"
        ...
        <p
          className="mt-0.5 font-michroma text-[8px] lg:mt-1 lg:text-[10px]"
      ...
      <p className="mt-1 truncate text-center font-michroma text-[8px] text-white/60 lg:mt-4 lg:text-[9px]">
