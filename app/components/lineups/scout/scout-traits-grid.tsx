  ...
  return (
    ...
    >
      <div className="mt-2 grid grid-cols-2 items-start gap-2 lg:grid-cols-[130px_130px_130px_130px] lg:gap-3">
        <div>
          <p className="font-michroma text-[7px] lg:text-[10px] uppercase text-emerald-400/60">
            Strengths
          </p>
          ...
          <div className="mt-1 grid gap-2">
            {lineupStrengths.map((strength) => (
              <p
                key={strength}
                className="font-michroma text-[7px] lg:text-[10px] text-white"
              >
        ...
        <div>
          <p className="font-michroma text-[7px] lg:text-[10px] uppercase text-red-400/60">
            Weaknesses
          </p>
        ...
        <div>
          <p className="font-michroma text-[7px] lg:text-[10px] uppercase text-[#EFBF04]">
            Tradeoff
          </p>

          <p className="mt-1 max-w-25 font-michroma text-[7px] lg:text-[10px] text-white">
            {lineupTradeoff}
          </p>
        </div>

        <div>
          <p className="font-michroma text-[7px] lg:text-[10px] uppercase text-white/30">
            Team Grades
          </p>

          <div className="mt-1 grid gap-1">
            <p className="font-michroma text-[6px] lg:text-[9px] text-white/35">
              Offense:{" "}
