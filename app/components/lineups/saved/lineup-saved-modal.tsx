...
export function LineupSavedModal({
  ...
  return (
    <div className="fixed inset-0 z-1000 flex animate-[modalBackdropIn_160ms_ease-out_both] items-center justify-center bg-black/70 px-3">
      <div className="w-full max-w-[300px] animate-[modalIn_180ms_ease-out_both] rounded-md border border-emerald-400/60 bg-[#07111f] p-4 text-center shadow-[0_0_30px_rgba(34,197,94,0.22)] lg:max-w-md lg:p-6">
