    ...
    <div className="mt-3 grid grid-cols-3 gap-2 lg:gap-5">
      {players.map((player, index) => {
        ...
        return (
          <div
            key={player.id}
            className="group relative min-w-0 rounded-md border border-[#1bc2ec]/30 bg-black/40 px-1.5 py-2 transition-all duration-200 hover:border-[#1bc2ec]/70 hover:bg-[#1bc2ec]/10 lg:px-4 lg:py-3"
          >
